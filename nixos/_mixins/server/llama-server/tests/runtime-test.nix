...
assert
  vulkanRuntime.selectedRuntimeModels.embedding.repoCacheDirectory
  == "/var/lib/llama-models/huggingface/hub/models--Qwen--Qwen3-Embedding-4B-GGUF";
assert
  vulkanRuntime.selectedRuntimeModels.embedding.resolvedPrimaryPathPattern
  == "/var/lib/llama-models/huggingface/hub/models--Qwen--Qwen3-Embedding-4B-GGUF/snapshots/*/Qwen3-Embedding-4B-Q8_0.gguf";
assert
  vulkanRuntime.selectedRuntimeModels.coding.runtimeArgs == [
    "--ctx-size"
    "262144"
    "--cache-type-k"
    "q8_0"
