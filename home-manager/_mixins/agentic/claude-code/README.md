...
- **[MCP servers](../mcp/README.md)** - Shared MCP servers (Codex, Context7, Exa, Linear, and conditional Slack) defined in the shared MCP module and delivered to Claude Code via `~/.config/mcp/mcp.json`
