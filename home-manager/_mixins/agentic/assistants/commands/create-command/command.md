...
Apply `write-command` end-to-end: form decision, portable structure, headers per provider, argument-hint, side-effect declaration. Do not duplicate that guidance here.
