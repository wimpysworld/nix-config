...
Load the `review-code` skill in direct worker mode. Do not launch agents or execute generated launch wrappers. Pass `code-review-colleague` as the `<review-name>` for the report filename.
