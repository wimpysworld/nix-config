...
For in-session briefings to a single specialist worker, use `handover-fork` instead - it produces a shorter briefing packet rather than a full handover document.
