...
| --- | --- | --- | --- | --- |
| batfink | claude | Unset | claude-opus-5 | max |
| batfink | opencode | anthropic | claude-opus-5 | Unset |
| batfink | opencode | openai | gpt-6-astra | Unset |
| batfink | codex | Unset | gpt-6-astra | xhigh |
| batfink | pi | anthropic | claude-opus-5 | max |
| batfink | pi | openai-codex | gpt-6-astra | xhigh |
| brain | claude | Unset | claude-opus-5 | high |
| brain | opencode | anthropic | claude-opus-5 | Unset |
| brain | opencode | openai | gpt-5.6-sol | Unset |
| brain | codex | Unset | gpt-5.6-sol | xhigh |
| brain | pi | anthropic | claude-opus-5 | high |
| brain | pi | openai-codex | gpt-5.6-sol | xhigh |
...
| dibble | claude | Unset | claude-opus-5 | max |
| dibble | opencode | anthropic | claude-opus-5 | Unset |
...
| garfield | claude | Unset | sonnet | high |
| garfield | opencode | anthropic | claude-sonnet-5 | Unset |
| garfield | opencode | openai | gpt-5.6-luna | Unset |
| garfield | codex | Unset | gpt-5.6-luna | high |
| garfield | pi | anthropic | claude-sonnet-5 | high |
| garfield | pi | google | gemini-3-flash | Unset |
| garfield | pi | openai-codex | gpt-5.6-luna | high |
| gonzales | claude | Unset | claude-opus-5 | high |
| gonzales | opencode | anthropic | claude-opus-5 | Unset |
| gonzales | opencode | openai | gpt-5.6-sol | Unset |
...
| penry | claude | Unset | claude-opus-5 | high |
| penry | opencode | anthropic | claude-opus-5 | Unset |
| penry | opencode | openai | gpt-5.6-sol | Unset |
