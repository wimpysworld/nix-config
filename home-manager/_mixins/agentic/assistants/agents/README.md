...
| --- | --- | --- | --- | --- |
| batfink | claude | Unset | claude-opus-5-5 | medium |
| batfink | opencode | anthropic | claude-opus-5-5 | Unset |
| batfink | opencode | openai | gpt-6-sol | Unset |
| batfink | codex | Unset | gpt-6-sol | xhigh |
| batfink | pi | anthropic | claude-opus-5-5 | medium |
| batfink | pi | openai-codex | gpt-6-sol | xhigh |
| brain | claude | Unset | claude-opus-5-5 | medium |
| brain | opencode | anthropic | claude-opus-5-5 | Unset |
| brain | opencode | openai | gpt-6-sol | Unset |
| brain | codex | Unset | gpt-6-sol | xhigh |
| brain | pi | anthropic | claude-opus-5-5 | medium |
| brain | pi | openai-codex | gpt-6-sol | xhigh |
| casper | claude | Unset | claude-sonnet-5 | high |
| casper | opencode | anthropic | claude-sonnet-5 | Unset |
| casper | opencode | openai | gpt-6-sol | Unset |
| casper | codex | Unset | gpt-6-sol | medium |
| casper | pi | anthropic | claude-sonnet-5 | high |
| casper | pi | openai-codex | gpt-6-sol | medium |
| dibble | claude | Unset | claude-opus-5-5 | medium |
| dibble | opencode | anthropic | claude-opus-5-5 | Unset |
| dibble | opencode | openai | gpt-6-astra | Unset |
| dibble | codex | Unset | gpt-6-astra | high |
| dibble | pi | anthropic | claude-opus-5-5 | medium |
| dibble | pi | openai-codex | gpt-6-astra | high |
| donatello | claude | Unset | claude-opus-5-5 | medium |
| donatello | opencode | anthropic | claude-opus-5-5 | Unset |
| donatello | opencode | openai | gpt-6-astra | Unset |
...
| garfield | claude | Unset | claude-sonnet-5 | high |
...
| garfield | pi | anthropic | claude-sonnet-5 | high |
...
| gonzales | opencode | anthropic | claude-opus-5-5 | Unset |
| gonzales | opencode | openai | gpt-6-sol | Unset |
| gonzales | codex | Unset | gpt-6-sol | xhigh |
| gonzales | pi | anthropic | claude-opus-5-5 | medium |
| gonzales | pi | openai-codex | gpt-6-sol | xhigh |
...
| penfold | codex | Unset | gpt-6-astra | high |
| penfold | pi | anthropic | claude-fable-5-1 | high |
| penfold | pi | openai-codex | gpt-6-astra | high |
| penry | claude | Unset | claude-opus-5-5 | medium |
| penry | opencode | anthropic | claude-opus-5-5 | Unset |
| penry | opencode | openai | gpt-6-sol | Unset |
| penry | codex | Unset | gpt-6-sol | xhigh |
| penry | pi | anthropic | claude-opus-5-5 | medium |
| penry | pi | openai-codex | gpt-6-sol | xhigh |
| rosey | claude | Unset | claude-opus-5-5 | medium |
| rosey | opencode | anthropic | claude-opus-5-5 | Unset |
| rosey | opencode | openai | gpt-6-astra | Unset |
| rosey | codex | Unset | gpt-6-astra | medium |
| rosey | pi | anthropic | claude-opus-5-5 | medium |
| rosey | pi | openai-codex | gpt-6-astra | medium |
| velma | claude | Unset | claude-sonnet-5 | high |
| velma | opencode | anthropic | claude-sonnet-5 | Unset |
| velma | opencode | openai | gpt-6-sol | Unset |
| velma | codex | Unset | gpt-6-sol | medium |
| velma | pi | anthropic | claude-sonnet-5 | high |
| velma | pi | openai-codex | gpt-6-sol | medium |
