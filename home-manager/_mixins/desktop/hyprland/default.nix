  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      windowrulev2 = [
        ...
        "float, class:(.blueman-manager-wrapped|blueberry.py|nm-connection-editor|polkit-gnome-authentication-agent-1)"
        "center, class:(.blueman-manager-wrapped|blueberry.py|nm-connection-editor|polkit-gnome-authentication-agent-1)"
