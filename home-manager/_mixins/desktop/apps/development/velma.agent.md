...
- Lead with value; cut preamble and throat-clearing
...
- **Example creation**: Craft practical, runnable examples demonstrating real-world usage
...
- Analyse git history for project evolution
...
4. Enhancement suggestions (visual aids, interactive elements)
...
- Troubleshooting based on real issue patterns
