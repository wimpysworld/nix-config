...
let
  ...
  mcpServers = {
    ...
    jina-mcp-server = {
      type = "http";
      url = "https://mcp.jina.ai/v1?exclude_tools=search_web,search_arxiv,search_ssrn,parallel_search_web,parallel_search_arxiv,parallel_search_ssrn";
      headers = {
  ...
  opencodeServers = {
    ...
    exa = {
      # Disbale because Exa is already included by default OpenCode
      enabled = false;
      type = "remote";
      url = "https://mcp.exa.ai/mcp";
    };
  ...
  copilotMcpServers = {
    ...
    jina-mcp-server = {
      ...
      args = [
        "-y"
        "mcp-remote"
        "https://mcp.jina.ai/v1?exclude_tools=show_api_key,search_web,search_arxiv,search_ssrn,parallel_search_web,parallel_search_arxiv,parallel_search_ssrn"
        "--header"
        "Authorization: Bearer ${config.sops.placeholder.JINA_API_KEY}"
      ];
      tools = [ "*" ];
