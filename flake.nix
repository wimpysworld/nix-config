{
  ...
  inputs = {
    ...
    hermes-agent.url = "https://github.com/NousResearch/hermes-agent/archive/refs/tags/v2026.9.14.tar.gz";
    ...
    concord.url = "github:chojs23/concord/v2.5.20";
    ...
    paseo.url = "github:getpaseo/paseo/v0.8.0";
